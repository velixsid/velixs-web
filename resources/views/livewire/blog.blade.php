<div>
    ...
    <main>
        <div class="relative border-t dark:border-slate-900 isolate overflow-hidden bg-white dark:bg-slate-950">
            ...
            <svg viewBox="0 0 1108 632" aria-hidden="true" class="dark:inline opacity-30 hidden absolute top-10 left-[calc(50%-4rem)] -z-10 w-[69.25rem] max-w-none transform-gpu blur-3xl sm:left-[calc(50%-18rem)] lg:left-48 lg:top-[calc(50%-30rem)] xl:left-[calc(50%-24rem)]">
        ...
        <div class="relative border-t dark:border-slate-800/50 px-6 pb-20 lg:px-10 lg:pb-28">
            <div class="relative mx-auto max-w-7xl">
                <div class="mx-auto mt-12 grid gap-4 lg:grid-cols-3 md:grid-cols-2">
