...
<body class="h-full dark:bg-gray-950">
    <div class="flex min-h-full flex-col pt-16 pb-12 overflow-hidden relative">
        ...
        <main class="mx-auto flex w-full max-w-7xl flex-grow flex-col justify-center px-6 lg:px-8">
            <div class="py-16">
                <div class="text-center">
                    <p class="mt-2 text-base text-gray-500 dark:text-gray-400">@yield('message')</p>
                    <div class="mt-6">
                        <a href="{!! url()->previous() !!}" class="text-base font-medium text-indigo-600 hover:text-indigo-500">
                            Back
