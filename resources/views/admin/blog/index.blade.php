    ...
    <script>
        $(function () {
            const table = new itables({
                ...
                url_delete: '{!! route('admin.blog.destroy') !!}',
                columns: [
                    { data: '' },
                    { data: 'id' },
                    { data: 'id' },
                            ...
                            return (
                                '<div class="d-inline-block">' +
                                    ...
                                    '<ul class="dropdown-menu dropdown-menu-end m-0">' +
                                        '<li><a href="{!! route('blog.detail','') !!}/'+ full.slug +'" class="dropdown-item itable-btn-detail">Details</a></li>' +
                                    '</ul>' +
                                '</div>' +
                                '<a href="{!! route('admin.blog.edit','') !!}/'+ full.id +'" class="btn btn-sm btn-icon item-edit itable-btn-edit"><i class="text-primary ti ti-pencil"></i></a>'
                            );
                        }
                    }
                ],
                buttons: [
                    ...
                    },
                    {
                        ...
                        action: function () { window.location.href = '{!! route('admin.blog.create') !!}'; }
                    },
                    {
                        text: '<i class="ti ti-rotate-clockwise me-sm-1"></i> <span class="d-none d-sm-inline-block">Trash</span>',
                        className: 'btn btn-warning',
                        action: function () { window.location.href = '{!! route('admin.blog.trash') !!}'; }
                    }
                ]
            });
        });
