...
@section('content')
<form id="submit" action="{!! route('admin.rapi.update', $row->id) !!}">
    @csrf
                ...
                <div class="tab-content card card-body rounded">
                    <div class="tab-pane fade show active" id="navs-pills-justified-general" role="tabpanel">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Name Api" name="title" value="{{ $row->title }}" autocomplete="off">
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="slug" value="{{ $row->slug }}" name="slug" autocomplete="off">
        ...
        <div class="col-12 col-xl-4 col-lg-4">
            ...
            <div class="card mb-3">
                <div class="card-body p-3 text-center">
                    <img class="card-img mb-2" style="height: 8rem; width: 8rem" id="preview" src="{!! $row->_image() !!}" alt="">
            ...
            <div class="card">
                <div class="card-body p-3">
                    ...
                    <select class="form-select" name="is_published">
                        <option {{ $row->is_published == 1 ? 'selected' : '' }} value="1">Active</option>
        ...
        tinymce.init({
            ...
            setup: function(editor) {
                editor.on('init', function(e) {
                    editor.setContent(`{!!str_replace(['{', '}'], ['&#123;', '&#125;'], $row->readme)!!}`);
                });
            },
        });
