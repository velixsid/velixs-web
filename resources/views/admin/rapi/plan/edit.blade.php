...
@section('content')
<form id="submit" action="{!! route('admin.plan.edit', $plan->_id) !!}">
    @csrf
    ...
    <div class="card">
        <div class="card-body">
            <div class="mb-3">
                ...
                <input type="text" name="plan" placeholder="Free" class="form-control" value="{{ $plan->plan }}" required>
            </div>
            <div class="row">
                <div class="col-12 col-lg-6 col-md-6">
                    <div class="mb-3">
                        <label class="form-label">Price</label>
                        <input type="text" name="price" placeholder="string: 10.000" value="{{ $plan->price }}" class="form-control" required>
                    </div>
                </div>
                <div class="col-12 col-lg-6 col-md-6">
                    <div class="mb-3">
                        <label class="form-label">Request / Days</label>
                        <input type="number" name="max_request" placeholder="10" value="{{ $plan->max_request }}" class="form-control" required>
                    </div>
                </div>
            </div>
            <div class="mb-3">
                ...
                <select name="default" class="form-select">
                    <option value="1" {{ $plan->default==true ? 'selected' : '' }}>true</option>
                    <option value="0" {{ $plan->default==false ? 'selected' : '' }}>false</option>
                </select>
            </div>
            <hr>
            ...
            <div class="row">
                <div class="col-12 col-lg-6 col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="button_title" placeholder="Whatsapp" value="{{ $plan->pricing->button->title }}" class="form-control" required>
                    </div>
                </div>
                <div class="col-12 col-lg-6 col-md-6">
                    <div class="mb-3">
                        <label class="form-label">Button Url</label>
                        <input type="text" name="button_url" placeholder="//wa.me" value="{{ $plan->pricing->button->url }}" class="form-control" required>
                    </div>
                </div>
            </div>
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table">
                        ...
                        <tbody class="table-border-bottom-0 table-body">
                            @if ($plan->pricing->list)
                                @foreach ($plan->pricing->list as $list)
                                    <tr>
                                        <td>
                                            <input type="text" class="form-control" name="listinclude[]" value="{{ $list }}" required>
                                        </td>
                                        <td>
