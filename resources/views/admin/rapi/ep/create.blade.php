...
@section('title', 'Create EndPoint')

@section('content')
<form id="submit" action="{!! route('admin.rapi.endpoint.store',$api->id) !!}">
    @csrf
    ...
    <div class="card">
        <div class="card-body">
            <div class="mb-3">
                ...
                <input type="text" name="url" placeholder="https://api.example.com/xxx" class="form-control" required>
            </div>
            <div class="row">
                <div class="col-12 col-lg-6 col-md-6">
                    <div class="mb-3">
                        <label class="form-label">Name</label>
                        <input type="text" name="title" placeholder="Name Endpoint" class="form-control" required>
                    </div>
                </div>
                <div class="col-12 col-lg-6 col-md-6">
                    <div class="mb-3">
            ...
            <div data-tab="data">
                <div class="terminal-cuy shadow">
                    ...
                    <div class="editor language-json p-3 text-sm" data-defeaultvalue='{}'></div>
