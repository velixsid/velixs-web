    ...
    <div class="relative flex min-h-full flex-col pt-16 pb-12 overflow-hidden">
        ...
        <main class="mx-auto flex w-full max-w-7xl flex-grow flex-col justify-center px-6 lg:px-8">
            <div class="py-16">
                <div class="text-center">
                    ...
                    <div class="mt-6">
                        <a href="{!! route('logout') !!}" class="text-base font-medium text-indigo-600 hover:text-indigo-500">
                            Logout
        ...
        <footer class="mx-auto w-full max-w-7xl flex-shrink-0 px-6 lg:px-8">
            <nav class="flex justify-center space-x-4">
                <a href="{!! route('contact') !!}" class="text-sm font-medium text-gray-500 animate-bounce hover:text-gray-600 dark:text-gray-300">Contact Admin</a>
            </nav>
        </footer>
    </div>
</body>
